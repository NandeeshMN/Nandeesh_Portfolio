      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center max-w-7xl mx-auto">
          ...
          <motion.div
            ...
            className="flex justify-center items-center order-1 lg:order-2 h-[300px] md:h-[400px] lg:h-[500px]"
          >
            <div className="relative w-full h-full max-h-[500px] max-w-[500px] rounded-full p-2 border-2 border-black/10 dark:border-white/10 shadow-2xl">
